...
ActiveRecord::Schema.define(version: 2020_07_01_030425) do
  ...
  create_table "analogs", force: :cascade do |t|
    ...
    t.index ["product_m_id"], name: "index_analogs_on_product_m_id"
  end
  ...
  add_foreign_key "analogs", "products", column: "product_a_id"
  add_foreign_key "analogs", "products", column: "product_m_id"
end
